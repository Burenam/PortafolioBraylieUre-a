        ...
        return(
            ...
            <div className="submit-form" >
                {this.state.submitted ? (
                    <div className="containerExito mt-4">
                        <h1>¡Marca Registrada con Exito!</h1>
                        <br></br>
                        <h3>¿Desea registrar otra marca?</h3>
                        <button className="btn btn-success btnG btn-block" onClick={this.newMarca}>Registrar marca</button>
                    </div>
                ): (
                    <div className="col-md-12">
                     ...
                     <div className="form-group">
                        ...
                        <input type="text" placeholder="Nombre de la Marca" className="form-control" id="name" required value={this.state.nombre_marca} onChange={this.onChangeName}name="name"/>

                     </div>
                     <div className="form-group">
                        <label htmlFor="nombre_solicitante" >Nombre del solicitante</label>
                        <input type="text" className="form-control" id="nombre_solicitante" placeholder="Nombre" required value={this.state.nombre_solicitante} 
                        onChange={this.onChangeNombreSolicitante} name="nombre_solicitante" />
                        
                     </div>
                     <div className="form-group">
                        <label htmlFor="clase_niza">Clase niza</label>
                        <input type="text" className="form-control" id="clase_niza" placeholder="1.2" required value={this.state.clase_niza} onChange={this.onChangeClaseNiza} name="clase_niza"/>
                     ...
                     <div className="form-group">
                        ...
                        <input type="text"className="form-control" id="detalle" placeholder="Detalle"value={this.state.detalle} onChange={this.onChangeDetalle} name="detalle" />
                     ...
                     <div className="form-group">
                        ...
                        <input type="file" className="form-control" id="logo"  onChange={this.onChangeLogo} name="logo"/>
                     </div>
                     
                     <button onClick={this.saveMarca} className="btn btnG btn-primary btn-block">Guardar</button>
